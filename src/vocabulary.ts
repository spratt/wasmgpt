// Pass 1 instruction vocabulary for WasmGPT.
// Registers all WASM instruction mnemonics, WAT structural keywords,
// type names, and syntax tokens with fixed integer IDs.
...
function reg(name: string): void {
  if (!vocab.has(name)) {
    vocab.set(name, nextId);
    nextId++;
  }
}

function regAll(names: StaticArray<string>): void {
...
export function initVocabulary(): void {
  vocab = new Map<string, i32>();
  nextId = 0;

  // --- Syntax tokens ---
  regAll(["(", ")"]);

  // --- WAT structural keywords ---
  regAll([
    "module", "type", "func", "import", "export",
    "memory", "table", "global", "data", "elem", "start",
    "param", "result", "local", "mut", "offset", "align",
  ]);

  // --- Value type names ---
  regAll(["i32", "i64", "f32", "f64", "v128", "funcref", "externref"]);

  // --- Control flow ---
  regAll([
    "unreachable", "nop", "block", "loop", "if", "else", "end",
    "try", "catch", "throw", "rethrow", "throw_ref", "delegate",
    "catch_all", "try_table",
  ...
  regAll([
    ...
    "table.init", "table.copy", "table.fill",
  ]);
  ...
  // --- Bulk memory ---
  regAll(["data.drop", "elem.drop"]);

  // --- Constants ---
  regAll(["i32.const", "i64.const", "f32.const", "f64.const"]);
  ...
  regAll([
    ...
    "i32.atomic.rmw.xchg", "i32.atomic.rmw.cmpxchg",
    "i32.atomic.rmw8.add_u", "i32.atomic.rmw8.sub_u",
    "i32.atomic.rmw8.and_u", "i32.atomic.rmw8.or_u", "i32.atomic.rmw8.xor_u",
    "i32.atomic.rmw8.xchg_u", "i32.atomic.rmw8.cmpxchg_u",
    "i32.atomic.rmw16.add_u", "i32.atomic.rmw16.sub_u",
    "i32.atomic.rmw16.and_u", "i32.atomic.rmw16.or_u", "i32.atomic.rmw16.xor_u",
    "i32.atomic.rmw16.xchg_u", "i32.atomic.rmw16.cmpxchg_u",
  ]);
  ...
  regAll([
    ...
    "i64.atomic.rmw.add", "i64.atomic.rmw.sub",
    "i64.atomic.rmw.and", "i64.atomic.rmw.or", "i64.atomic.rmw.xor",
    "i64.atomic.rmw.xchg", "i64.atomic.rmw.cmpxchg",
    "i64.atomic.rmw8.add_u", "i64.atomic.rmw8.sub_u",
    "i64.atomic.rmw8.and_u", "i64.atomic.rmw8.or_u", "i64.atomic.rmw8.xor_u",
    "i64.atomic.rmw8.xchg_u", "i64.atomic.rmw8.cmpxchg_u",
    "i64.atomic.rmw16.add_u", "i64.atomic.rmw16.sub_u",
    "i64.atomic.rmw16.and_u", "i64.atomic.rmw16.or_u", "i64.atomic.rmw16.xor_u",
    "i64.atomic.rmw16.xchg_u", "i64.atomic.rmw16.cmpxchg_u",
    "i64.atomic.rmw32.add_u", "i64.atomic.rmw32.sub_u",
    "i64.atomic.rmw32.and_u", "i64.atomic.rmw32.or_u", "i64.atomic.rmw32.xor_u",
    "i64.atomic.rmw32.xchg_u", "i64.atomic.rmw32.cmpxchg_u",
  ]);

  // --- Atomic fence and wait/notify ---
  regAll([
    "atomic.fence",
  ...
  regAll([
    ...
    "i8x16.relaxed_swizzle", "i8x16.relaxed_laneselect",
  ]);
  ...
  regAll([
    ...
    "f32x4.eq", "f32x4.ne",
    "f32x4.lt", "f32x4.gt", "f32x4.le", "f32x4.ge",
    "f32x4.abs", "f32x4.neg",
    "f32x4.sqrt", "f32x4.add", "f32x4.sub", "f32x4.mul", "f32x4.div",
  ...
  regAll([
    ...
    "f64x2.eq", "f64x2.ne",
    "f64x2.lt", "f64x2.gt", "f64x2.le", "f64x2.ge",
    "f64x2.abs", "f64x2.neg",
    "f64x2.sqrt", "f64x2.add", "f64x2.sub", "f64x2.mul", "f64x2.div",
